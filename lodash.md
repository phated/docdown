...
### <a id="iteratortemplatedata"></a>`iteratorTemplate(data)`
<a href="#iteratortemplatedata">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L348 "View in source") [&#x24C9;][1]

The template used to create iterator functions.

#### Arguments
1. `data` *(Obect)*: The data object used to populate the text.

#### Returns
*(String)*: Returns the interpolated text.
...
### <a id="cachedcontainsarray-value--fromindex0-largesize30"></a>`cachedContains(array, value [, fromIndex=0, largeSize=30])`
<a href="#cachedcontainsarray-value--fromindex0-largesize30">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L491 "View in source") [&#x24C9;][1]
...
2. `value` *(Mixed)*: The value to search for.
3. `[fromIndex=0]` *(Number)*: The index to search from.
4. `[largeSize=30]` *(Number)*: The length at which an array is considered large.
...
### <a id="charatcallbackvalue"></a>`charAtCallback(value)`
<a href="#charatcallbackvalue">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L525 "View in source") [&#x24C9;][1]

Used by `_.max` and `_.min` as the default `callback` when a given `collection` is a string value.

#### Arguments
1. `value` *(String)*: The character to inspect.

#### Returns
*(Number)*: Returns the code unit of given character.
...
### <a id="compareascendinga-b"></a>`compareAscending(a, b)`
<a href="#compareascendinga-b">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L538 "View in source") [&#x24C9;][1]

Used by `sortBy` to compare transformed `collection` values, stable sorting them in ascending order.

#### Arguments
1. `a` *(Object)*: The object to compare to `b`.
2. `b` *(Object)*: The object to compare to `a`.

#### Returns
*(Number)*: Returns the sort order indicator of `1` or `-1`.
...
### <a id="createboundfunc--thisarg-partialargs"></a>`createBound(func [, thisArg], partialArgs)`
<a href="#createboundfunc--thisarg-partialargs">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L569 "View in source") [&#x24C9;][1]

Creates a function that, when called, invokes `func` with the `this` binding of `thisArg` and prepends any `partailArgs` to the arguments passed to the bound function.

#### Arguments
1. `func` *(Function|String)*: The function to bind or the method name.
2. `[thisArg]` *(Mixed)*: The `this` binding of `func`.
3. `partialArgs` *(Array)*: An array of arguments to be partially applied.
...
### <a id="createcallbackfuncidentityproperty-thisarg-accumulating"></a>`createCallback([func=identity|property, thisArg, accumulating])`
<a href="#createcallbackfuncidentityproperty-thisarg-accumulating">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L624 "View in source") [&#x24C9;][1]

Produces an iteration callback bound to an optional `thisArg`. If `func` is a property name, the callback will return the property value for a given element.

#### Arguments
1. `[func=identity|property]` *(Function|String)*: The function called per
   * iteration or property name to query.
2. `[thisArg]` *(Mixed)*: The `this` binding of `callback`.
3. `[accumulating]` *(Object)*: Used to indicate that the callback should
...
### <a id="createiteratoroptions1-options2-"></a>`createIterator([options1, options2, ...])`
<a href="#createiteratoroptions1-options2-">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L660 "View in source") [&#x24C9;][1]

Creates compiled iteration functions.

#### Arguments
1. `[options1, options2, ...]` *(Object)*: The compile options object(s).
...
### <a id="eachcollection--callbackidentity-thisarg"></a>`each(collection [, callback=identity, thisArg])`
<a href="#eachcollection--callbackidentity-thisarg">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L709 "View in source") [&#x24C9;][1]
...
### <a id="escapestringcharmatch"></a>`escapeStringChar(match)`
<a href="#escapestringcharmatch">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L719 "View in source") [&#x24C9;][1]

Used by `template` to escape characters for inclusion in compiled string literals.

#### Arguments
1. `match` *(String)*: The matched character to escape.
...
### <a id="escapehtmlcharmatch"></a>`escapeHtmlChar(match)`
<a href="#escapehtmlcharmatch">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L730 "View in source") [&#x24C9;][1]
...
### <a id="isnodevalue"></a>`isNode(value)`
<a href="#isnodevalue">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L741 "View in source") [&#x24C9;][1]
...
### <a id="slicecollection-start-end"></a>`slice(collection, start, end)`
<a href="#slicecollection-start-end">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L769 "View in source") [&#x24C9;][1]
...
#### Arguments
1. `collection` *(Array|Object|String)*: The collection to slice.
2. `start` *(Number)*: The start index.
3. `end` *(Number)*: The end index.
...
### <a id="unescapehtmlcharmatch"></a>`unescapeHtmlChar(match)`
<a href="#unescapehtmlcharmatch">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L791 "View in source") [&#x24C9;][1]

Used by `unescape` to convert HTML entities to characters.

#### Arguments
1. `match` *(String)*: The matched character to unescape.
...
### <a id="shimisplainobjectvalue"></a>`shimIsPlainObject(value)`
<a href="#shimisplainobjectvalue">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L926 "View in source") [&#x24C9;][1]

A fallback implementation of `isPlainObject` that checks if a given `value` is an object created by the `Object` constructor, assuming objects created by the `Object` constructor have no inherited enumerable properties and that there are no `Object.prototype` extensions.
...
### <a id="shimkeysobject"></a>`shimKeys(object)`
<a href="#shimkeysobject">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L964 "View in source") [&#x24C9;][1]

A fallback implementation of `Object.keys` that produces an array of the given object's own enumerable property names.
...
<a href="#_version">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L4422 "View in source") [&#x24C9;][1]
...
<a href="#_templatesettings">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L300 "View in source") [&#x24C9;][1]
...
<a href="#_templatesettingsescape">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L309 "View in source") [&#x24C9;][1]
...
<a href="#_templatesettingsevaluate">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L318 "View in source") [&#x24C9;][1]
...
<a href="#_templatesettingsinterpolate">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L327 "View in source") [&#x24C9;][1]
...
<a href="#_templatesettingsvariable">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L336 "View in source") [&#x24C9;][1]
...
### <a id="noop"></a>`noop`
<a href="#noop">#</a> [&#x24C8;](https://github.com/bestiejs/lodash/blob/master/lodash.js#L752 "View in source") [&#x24C9;][1]
